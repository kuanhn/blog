...
tags: 
    ...
    - cryptocurrencies
category: Read
thumbnail: /blog/css/images/20180131/thumbnail.jpg
---
# Tản mạn
...
## Block là gì?
Khi xem lại hết mấy cái ví dụ về __hash__ vẫn chưa thấy sự liên quan ở đây nên mình chuyển vấn đề tìm hiểu sang __block__. Sau chỉ một lần tìm kiếm Google cũng đã nhanh chóng có được câu trả lời như sau trên Wikipedia.
...
![Con trỏ hash](/blog/css/images/20180131/hash_pointer.png)
...
![Cấu trúc Blockchain](/blog/css/images/20180131/blockchain.png)
...
![Chuỗi các giao dịch trong được Satoshi nhắc tới](/blog/css/images/20180131/transactions.jpg)
...
- __Owner1__ sẽ ký lên mã __hash__ của khối giao dịch trước đó (lần mà __Owner1__ là người nhận) cùng với việc thêm vào địa chỉ người nhận TO: khoá công khai của __Owner2__.
...
![GoofyCoin](/blog/css/images/20180131/goofycoin.png)
...
![Double-spending khi sử dụng GoofyCoin](/blog/css/images/20180131/goofy_coin_double_spending.png)
...
![ScroogeCoin](/blog/css/images/20180131/scroogecoin.png)
